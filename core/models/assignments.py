...
class Assignment(db.Model):
    ...
    @classmethod
    def grade_assignment(cls, p_assignment, incoming_payload):
        assignment = Assignment.get_by_id(p_assignment.id)

        assertions.assert_found(assignment, "No assignment found with this id")
        assertions.assert_found(assignment.state == AssignmentStateEnum.SUBMITTED, 'Only a submmitted assignment can be graded')
        assertions.assert_found(incoming_payload['grade'] == GradeEnum, "ValidationError")
